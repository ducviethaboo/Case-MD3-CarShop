        ...
        <div class="container">
            <div class="row content_bottom-text">
                <div class="col-md-7">
                    ...
                    <br>
                    <p class="m_2">Đầu xe chắc khỏe, hiệu quả về mặt chức năng vẫn giữ được đặc trưng của nó trong nhiều thập kỷ. Một đường gân nổi thẳng tắp và bề mặt phẳng lớn tạo nên sườn xe. Đặc trưng riêng của xe là bản lề cửa nằm ngoài, thanh bảo vệ bên ngoài hai bên hông và bánh xe dự phòng treo trên cửa hậu. Lớp lót vành bánh xe nổi bật và vệt bánh xe rộng mang đến một vẻ ngoài đầy uy lực.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row content_bottom-text">
                <div class="col-md-7">
                    ...
                    <br>
                    <p class="m_2">Nội thất được thiết kế lại hoàn toàn đạt tới một cấp độ mới. Không còn nghi ngờ gì nữa, ngôn ngữ thiết kế và tỷ lệ trong nội thất mang đậm phong cách của xe G-Class: tự tin, góc cạnh, mang tính biểu tượng. Như thể tự nhiên trở thành thần hộ mệnh cho nội thất rộng rãi, phóng khoáng của G-Class. Ý tưởng không gian tạo ra hình mẫu cho sự rộng rãi và thoải mái của mọi người ngồi trên xe G-Class.
                    </p>
                </div>
            </div>
        </div>
